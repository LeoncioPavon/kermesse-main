...
$tu = new tbl_rol();
$dtu = new dt_tbl_rol();
$cu = new rolController();


if (isset($_GET['id_rol'])) {
    $id_rol = $_GET['id_rol'];
    $dtu->eliminarRol($id_rol);
}
?>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Roles Agregados</h5>
                  ...
                  ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $r->getRolDescripcion(); ?>
                                        </td>
                                        <td>
                                            <a href="editar_rol.php?id_rol=<?php echo $r->getIdRol(); ?>">
                                                <button type="button" class="btn btn-outline-success"
                                                    title="Editar Rol">Editar</button>
                                            </a>
                                            <a href="roles.php?id_rol=<?php echo $r->getIdRol(); ?>">
                                                <button type="button" class="btn btn-outline-danger"
                                                    title="Eliminar Rol">Eliminar</button>
                                            </a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
