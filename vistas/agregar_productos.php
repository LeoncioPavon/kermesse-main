...
$dtcp = new dt_tbl_categoria();
$cp = new categoriaController();
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <select class="form-control" id="id_cat_producto" name="id_cat_producto"
                                        placeholder="Zip">
                                        <option selected>Selecciona Una Categoria</option>
                                        <?php
                                        foreach ($dtcp->listarCategoriaPrueba() as $r) :
                                        ?>
                                        <option>
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <select class="form-control" id="idComunidad" name="id_comunidad" placeholder="Zip">
                                        <option selected>Selecciona Una Comunidad</option>
                                        <?php
                                        foreach ($dtc->listarComunidadPrueba() as $r) :
                                        ?>
                                        <option>
