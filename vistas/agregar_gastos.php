...
if(isset($_POST['m'])){
    $metodo = $_POST['m'];
    if(method_exists("categoriagastosController",$metodo))
    {
        categoriagastosController::{$metodo}();
    }
}
?>
...
<body>
  ...
  ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Agregar Categoria Gastos</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item">Pages</li>
                    <li class="breadcrumb-item active">Agregar Categoria Gastos</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" novalidate method="POST">
                        <div class="col-md-12">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="validationCustom01" id="floatingName"
                                    placeholder="Your Name" name="nombre_categoria" required>
                        ...
                        <div class="text-center">
                            ...
                            <input type="hidden" name="m" value="guardarCategoriaGastos">
