            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  ?>
                                    <tr>
                                        <td>
                                            <?php echo $r->getIdProducto(); ?>
                                        </td>
                                        <td>
                                            <?php echo $r->getIdComunidad(); ?>
                                        </td>
                                        <td>
                                            <?php echo $r->getIdCatProducto(); ?>
                                        </td>
                                        <td>
                                            <?php echo $r->getNombre(); ?>
                                        </td>
                                        <td>
                                            <?php echo $r->getDescripcion(); ?>
                                        </td>
                                        <td>
                                            <?php echo $r->getCantidad(); ?>
                                        </td>
                                        <td>
                                            <?php echo $r->getPreciovSugerido(); ?>
                                        </td>
                                        <td>
                                            <a
                                            ...
                                            <a href="producto.php?id_producto=<?php echo $r->getIdProducto(); ?>">
